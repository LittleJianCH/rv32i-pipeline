...
decoder i = case i of
  $(bitPattern "0000000..........000.....0110011") {- add -}
    -> (AluInstr Add (Just rs1) rs2 Nothing Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern "0100000..........000.....0110011") {- sub -}
    -> (AluInstr Sub (Just rs1) rs2 Nothing Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern "0000000..........100.....0110011") {- xor -}
    -> (AluInstr Xor (Just rs1) rs2 Nothing Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern "0000000..........110.....0110011") {- or -}
    -> (AluInstr Or (Just rs1) rs2 Nothing Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern "0000000..........111.....0110011") {- and -}
    -> (AluInstr And (Just rs1) rs2 Nothing Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern "0000000..........001.....0110011") {- sll -}
    -> (AluInstr Sll (Just rs1) rs2 Nothing Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern "0000000..........101.....0110011") {- srl -}
    -> (AluInstr Srl (Just rs1) rs2 Nothing Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern "0100000..........101.....0110011") {- sra -}
    -> (AluInstr Sra (Just rs1) rs2 Nothing Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern "0000000..........010.....0110011") {- slt -}
    -> (AluInstr Slt (Just rs1) rs2 Nothing Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern "0000000..........011.....0110011") {- sltu -}
    -> (AluInstr Sltu (Just rs1) rs2 Nothing Rd, pcNext, PassbyMem, WriteReg rd)

  $(bitPattern ".................000.....0010011") {- addi -}
    -> (AluInstr Add (Just rs1) 0 (Just sImmI) Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern ".................100.....0010011") {- xori -}
    -> (AluInstr Xor (Just rs1) 0 (Just sImmI) Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern ".................110.....0010011") {- ori -}
    -> (AluInstr Or (Just rs1) 0 (Just sImmI) Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern ".................111.....0010011") {- andi -}
    -> (AluInstr And (Just rs1) 0 (Just sImmI) Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern "0000000..........000.....0010011") {- slli -}
    -> (AluInstr Sll (Just rs1) 0 (Just sImmI) Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern "0000000..........101.....0010011") {- srli -}
    -> (AluInstr Srl (Just rs1) 0 (Just sImmI) Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern "0100000..........101.....0010011") {- srai -}
    -> (AluInstr Sra (Just rs1) 0 (Just sImmI) Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern ".................010.....0010011") {- slti -}
    -> (AluInstr Slt (Just rs1) 0 (Just sImmI) Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern ".................011.....0010011") {- sltiu -}
    -> (AluInstr Sltu (Just rs1) 0 (Just uImmI) Rd, pcNext, PassbyMem, WriteReg rd)

  $(bitPattern ".................000.....0000011") {- lb -}
    -> (AluInstr Add (Just rs1) 0 (Just sImmI) Rd, pcNext, ReadMem Byte, WriteReg rd)
  $(bitPattern ".................001.....0000011") {- lh -}
    -> (AluInstr Add (Just rs1) 0 (Just sImmI) Rd, pcNext, ReadMem Half, WriteReg rd)
  $(bitPattern ".................010.....0000011") {- lw -}
    -> (AluInstr Add (Just rs1) 0 (Just sImmI) Rd, pcNext, ReadMem Word, WriteReg rd)
  $(bitPattern ".................100.....0000011") {- lbu -}
    -> (AluInstr Add (Just rs1) 0 (Just sImmI) Rd, pcNext, ReadMem UByte, WriteReg rd)
  $(bitPattern ".................101.....0000011") {- lhu -}
    -> (AluInstr Add (Just rs1) 0 (Just sImmI) Rd, pcNext, ReadMem UHalf, WriteReg rd)
  ...
  $(bitPattern ".........................1101111") {- jal -}
    -> (AluInstr Add Nothing 0 (Just 4) Rd, Jump (signExtend immJ), PassbyMem, WriteReg rd)
  $(bitPattern ".........................1100111") {- jalr -}
    -> (AluInstr Add (Just rs1) 0 (Just sImmI) JumpTarget, JumpAlu, PassbyMem, passByWB)

  $(bitPattern ".........................0110111") {- lui -}
    -> (AluInstr Or (Just 0) 0 (Just immU) Rd, pcNext, PassbyMem, WriteReg rd)
  $(bitPattern ".........................0010111") {- auipc -}
    -> (AluInstr Add Nothing 0 (Just immU) Rd, pcNext, PassbyMem, WriteReg rd)
